...
public class ModelListView  extends Composite{
	...
	private void createContent() {
		 ...
		 viewer.setContentProvider( new ModelListContentProvider() );
		 viewer.setLabelProvider(new ModelListLabelProvider());
		 viewer.setInput(pp.getPageIdToTitle());
