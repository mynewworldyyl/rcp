...
public class ForumPageContainer extends Composite implements ModelChangedListener{
	...
	public ForumPageContainer(Composite parent,int style) {
		super(parent,style);
	...
	private void createToolBar(Composite contentBar) {
		...
		cancelBtn.addSelectionListener(new SelectionAdapter(){
			...
			public void widgetSelected(SelectionEvent e) {
				...
				//CmtyWindow.hidePane(ForumWindow.PREFERENCE_WINDOW_ID);
			}
