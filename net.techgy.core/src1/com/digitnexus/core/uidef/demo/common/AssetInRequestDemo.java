...
/*@TableViewEditor(
		...
		actions = {
				...
				@Action(name="Modify", url="requestDemo/update",actionType=ActionType.Modify),
		...
		itemActions = {
				...
				@Action(name="Delete", url="" ,actionType=ActionType.Delete),
				//save request
				@Action(name="Save", url="requestDemo/save",actionType=ActionType.Save),
				//@Action(name="Modify", url="",actionType=ActionType.Update),
				//Cancel this request for this update or create
				@Action(name="Cancel", url="" ,actionType=ActionType.Cancel),
		},
		namedParams = {
...
public class AssetInRequestDemo{
	...
	@ListItems
	private List<RequestItemDemo> items = new ArrayList<RequestItemDemo>();
